        ...
        <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="Card1 p-5  w-full lg:w-1/2 rounded-lg bg-zinc-800 shadow-md shadow-zinc-600 border-[#eee]">
            <img
              ...
              alt="Placeholder"
            />
            <h2 className="text-lg md:text-xl text-white font-semibold mt-4">Total Bidding Price:</h2>
            <h2 className="text-lg md:text-xl text-white font-semibold mt-2">Token Price:</h2>
          </div>
          ...
          <div className="w-full  lg:w-1/2 flex flex-col gap-5">
            ...
            <div className="p-5 text-white w-full rounded-lg shadow-md shadow-zinc-600 bg-zinc-800">
              <h2 className="text-xl md:text-2xl font-sans font-semibold">Refund Status</h2>
              <h3 className="mt-3">
                <i className="ri-checkbox-circle-fill text-green-500 text-xl md:text-2xl"></i> Payment Recieved
              </h3>
              <h3 className="mt-3">
...
export default BidTokenMoneyPayment;
